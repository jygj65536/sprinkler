      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 8 }}>
        ...
        {weatherPermission === 'denied' && (
          <button
            ...
            style={{ fontSize: 16, color: 'var(--soft)', fontWeight: 500, background: 'none', border: 'none', cursor: 'pointer', padding: 0, fontFamily: 'KJD, sans-serif', flexShrink: 0, textDecoration: 'underline', textDecorationStyle: 'dotted', textUnderlineOffset: 3, letterSpacing: '.5px' }}
          >
            📍 위치 켜기
          </button>
        )}
