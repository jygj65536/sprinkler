...
const FOLIAGE: Partial<Record<PlantType, string>> = {
  ...
  palm:
    '<path d="M59 80 C59 68 59 60 59 52"/>' +
    '<path d="M59 52 C50 49 42 49 34 53"/>' +
    '<path d="M59 52 C68 49 76 49 84 53"/>' +
    '<path d="M59 52 C52 43 46 39 39 37"/>' +
    '<path d="M59 52 C66 43 72 39 79 37"/>' +
    '<path d="M59 52 C58 42 58 36 60 30"/>' +
    '<path d="M59 52 C44 52 38 56 33 61"/>' +
    '<path d="M59 52 C74 52 80 56 85 61"/>',
  succulent:
  ...
  tropical:
    '<path d="M60 80 C40 73 27 55 31 39 C33 31 43 29 51 37 C62 47 66 65 60 80 Z"/>' +
    '<path d="M54 74 C47 62 44 50 47 39"/>' +
    '<path d="M50 64 C45 64 41 61 38 57"/>' +
    '<path d="M52 52 C48 52 45 50 43 47"/>' +
    '<path d="M61 80 C73 74 83 62 82 50 C81 43 73 42 67 48 C60 55 58 69 61 80 Z"/>' +
    '<path d="M65 73 C71 63 74 55 73 47"/>',
  foliage:
  ...
  tree:
    '<path d="M60 80 L60 58"/>' +
    '<path d="M60 70 L52 63"/>' +
    '<path d="M60 66 L68 59"/>' +
    '<path d="M44 56 C35 56 31 45 40 41 C40 31 56 29 60 38 C64 29 80 31 80 41 C89 45 85 56 76 56 C70 60 50 60 44 56 Z"/>' +
    '<path d="M53 80 L67 80"/>',
  herb:
  ...
  stuckyi:
    '<path d="M55 80 C53 60 51 44 54 28 C55 24 57 24 58 28 C60 45 59 62 59 80"/>' +
    '<path d="M65 80 C65 57 67 40 72 28 C74 24 76 25 75 30 C72 48 69 63 69 80"/>' +
    '<path d="M46 80 C45 61 42 48 38 38 C36 34 38 33 40 37 C46 50 50 64 51 80"/>' +
    '<path d="M60 80 C61 66 62 54 64 44"/>',
  cactus:
...
const _CAN_PATHS = `<path d="M48 64 Q47 61 50 61 L82 61 Q85 61 84 64 L79 92 Q78 96 74 96 L56 96 Q52 96 51 92 Z"/><path d="M50 66 Q66 71 82 66"/><path d="M56 61 C57 46 77 46 78 61"/><path d="M50 70 C40 67 30 62 22 53 L17 58 C26 67 37 73 49 77"/><path d="M13 64 c-2 3 -2 6 0 7 c2 -1 2 -4 0 -7 Z"/><path d="M19 69 c-1.5 2.5 -1.5 5 0 6 c1.5 -1 1.5 -3.5 0 -6 Z"/><path d="M9 70 c-1.5 2.5 -1.5 5 0 6 c1.5 -1 1.5 -3.5 0 -6 Z"/>`;
